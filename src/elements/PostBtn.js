...
const PostBtn = (props) => {
  ...
  if (type == "Dm") {
    return (
      <Dm viewBox={"0 0 24 24"} fill={"#8e8e8e"} role={"img"}>
        <line
          fill={"none"}
          stroke={"currentColor"}
  ...
  if (type == "Comment") {
    return (
      <Comment viewBox={"0 0 24 24"} fill={"#8e8e8e"} role={"img"}>
        <path
  ...
  if (type == "BookMark") {
    return (
      <BookMark viewBox={"0 0 24 24"} fill={"#8e8e8e"} role={"img"}>
        <polygon
          fill={"none"}
  ...
  return (
    <Heart viewBox={"0 0 24 24"} fill={"#8e8e8e"} role={"img"}>
      <path
        d={
